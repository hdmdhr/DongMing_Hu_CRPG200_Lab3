...
namespace DongMing_Hu_CRPG200_Lab3.NorthwindDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DongMing_Hu_CRPG200_Lab3.Properties.Settings.Default.NorthwindConnectionString;
        }
